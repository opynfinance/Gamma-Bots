...
exports.handler = async function (credentials) {
	...
	provider = new ethers.providers.JsonRpcProvider("http://18.117.106.118:8547/")
	signer = new ethers.Wallet(
		credentials.secrets.REDUNDANT_VAULT_COLLAT_PK,
		provider
	)
...
if (require.main === module) {
	...
	exports
		.handler({ apiKey, apiSecret }, false)
		.then(() => process.exit(0))
		.catch(error => {
			console.error(error)
